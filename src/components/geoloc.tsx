...
export const Geoloc = ({ color, isFill }: TIconProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={color ? color : 'currentColor'} className="bi bi-pin-map-fill" viewBox="0 0 16 16">
